...
-- Remover policies legadas identificadas na auditoria da tabela services.
DROP POLICY IF EXISTS "Authenticated users can manage services" ON public.services;
DROP POLICY IF EXISTS "Company members can manage services" ON public.services;
DROP POLICY IF EXISTS "Anyone can view services" ON public.services;
DROP POLICY IF EXISTS "Services are viewable by everyone" ON public.services;

-- SELECT autenticado: somente quem possui services.view.
...
-- SELECT público: somente serviços ativos para usuários anônimos.
-- Não concede acesso adicional ao role authenticated.
...
-- INSERT: somente quem possui services.create.
...
-- UPDATE: somente quem possui services.edit.
...
-- DELETE: somente quem possui services.delete.
