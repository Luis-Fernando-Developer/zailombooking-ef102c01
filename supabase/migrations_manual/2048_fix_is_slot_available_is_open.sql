-- ============================================================================
-- 2048 — Hotfix: is_slot_available referenciava business_hours.is_closed,
-- mas a coluna real é `is_open`. Ajusta a condição e recria a view dependente.
-- Sintoma: POST /v1/bookings retornava
