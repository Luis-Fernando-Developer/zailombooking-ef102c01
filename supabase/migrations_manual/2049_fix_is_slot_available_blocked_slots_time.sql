-- ============================================================================
-- 2049 — Hotfix: is_slot_available quebrava com
--   "function tstzrange(time without time zone, time without time zone, unknown) does not exist"
-- porque public.blocked_slots.start_time/end_time são TIME neste banco.
-- Substitui a checagem por OVERLAPS com ::TIME, mesmo padrão de get_available_slots.
-- ============================================================================
