        ...
        <div className="grid md:grid-cols-3 gap-16">
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="w-24 h-24 bg-gradient-primary rounded-3xl flex  justify-center mx-auto mb-10 relative z-10 card-glow group-hover:scale-110 transition-transform duration-300">
