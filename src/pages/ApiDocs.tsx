...
const ENDPOINTS: Endpoint[] = [
  ...
  // -------------------- Agendamentos --------------------
  {
    ...
    description:
      "Cria um agendamento. Use `booking_date` + `booking_time` como fonte única; `start_time` é apenas compatibilidade legada e será rejeitado se divergir.",
    params: [
      ...
      { name: "booking_date", type: "date", location: "body", required: true, description: "YYYY-MM-DD ou DD/MM/YYYY" },
